"""
Unit tests for ConditionalTNGScope.

Guarantees:
- Can run without torchair installed
- Can run from omniinfer repo root or sglang directory
- No dependency on repo name, PYTHONPATH, or conftest
"""
